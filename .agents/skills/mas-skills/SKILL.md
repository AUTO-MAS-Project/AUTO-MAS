...
8. Backend tests follow `tests/README.md`; run the smallest affected file or domain by default, and do not expand to the full suite without a documented trigger.
