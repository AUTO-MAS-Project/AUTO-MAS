...
- 【MFW】项目更新包先走 GitHub 加速镜像并可回退直连，重试退避，进度带预计剩余时间（仅公测） (#946) by @qiyinxi

### 修复

- 【MAA】修复脚本模式下多个自定义基建用户共用班次指针、重试时提前换到下一班的问题 (#940) by @qiyinxi
- 【HSR】修复脚本直控忽略日常/周常超时设置、固定 120 分钟后才终止卡住脚本的问题 (#936) by @qiyinxi
- 【MFW】运行前自动更新显示下载进度，停止任务即中止下载，新增脚本级代理地址（仅公测） (#944) by @qiyinxi
