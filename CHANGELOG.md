...
- 【MAA】修复 MAA 模拟器绑定迁移重置及日志缺失时任务超时卡住的问题。 (#1051) by @1w1w11w1

### 修复

- 【M9A】修复旧版升级后自定义关卡被清空、切换账号丢失与错序，启动、切号、关闭游戏改由 MAS 自动加入（仅公测） (#1033) by @qiyinxi
- 【MFW】修复 MFW 雷电重试重开模拟器后截图连接失败，第 2、3 次尝试直接作废 (#1035) by @qiyinxi
- 【MFW】修复部分项目（如 M9A v4.10.0）第一个任务开始就被自身分辨率检查停止的问题 (#1036) by @qiyinxi
- 【MFW】修复项目带多种架构运行库时选错架构无法运行，以及运行环境反复准备失败的问题 (#1034) by @qiyinxi
