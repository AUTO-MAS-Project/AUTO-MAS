...
- 【MFW】修复同时带多种架构的项目选错 MaaFramework 无法运行，架构不符时不再反复重试 (#1032) by @qiyinxi
- 【MFW】修复 MFW 雷电重试重开模拟器后截图连接失败，第 2、3 次尝试直接作废 (#1031) by @qiyinxi
- 【MFW】修复部分项目（如 M9A v4.10.0）第一个任务开始就被自身分辨率检查停止的问题 (#1030) by @qiyinxi
