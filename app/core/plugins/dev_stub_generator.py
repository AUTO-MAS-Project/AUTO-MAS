...
def _render_context_stub() -> str:
    ...
    lines.extend(_render_class_stub(PluginContext, class_attrs))
    lines.append("")
    lines.extend(_render_class_stub(RuntimeFacade, runtime_facade_attrs))
    lines.append("")
    return "\n".join(lines)
...
def _render_runtime_api_stub() -> str:
    ...
    lines.extend(_render_class_stub(RuntimeAPI, {}))
    lines.append("")
    return "\n".join(lines)
...
def _render_cache_store_stub() -> str:
    ...
    lines.extend(_render_class_stub(JsonPluginCache, cache_attrs))
    lines.append("")
    lines.extend(_render_class_stub(PluginCacheManager, manager_attrs))
    lines.append("")
    return "\n".join(lines)
