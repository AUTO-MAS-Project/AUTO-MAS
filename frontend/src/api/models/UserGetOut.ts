...
export type UserGetOut = {
     ...
     */
    data: Record<string, (MaaUserConfig | SrcUserConfig | GeneralUserConfig | OkwwUserConfig | OkNteUserConfig | MaaEndUserConfig | M9AUserConfig | HSRUserConfig | BetterGIUserConfig)>;
};
