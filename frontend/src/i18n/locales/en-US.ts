...
export default {
  ...
  edit: {
    ...
    okscriptRunTimeLimitHint:
      'Counted from project launch; if no completion marker appears within this time, the project is stopped and the run is marked unconfirmed (never counted as success)',
