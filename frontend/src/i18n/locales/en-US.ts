...
export default {
  ...
  edit: {
    ...
    // OkScript general adapter
    okscriptScriptConfiguration: 'OkScript script settings',
    okscriptScriptNameHint: 'Tells OkScript script instances apart',
    okscriptNotOkScript: 'This script is not an OkScript script',
    okscriptProject: 'ok-script project',
    okscriptRootPath: 'Install folder',
    okscriptRootPathHint:
      'Install root of the ok-script project (ok-ef for now): the folder holding "<project>.exe" and the data folder',
    okscriptPickRootPath: 'Pick the install folder of the ok-script project',
    okscriptProbeFailed: 'This folder could not be recognized',
    okscriptProbeSucceeded: 'Recognized {name} {version}',
    okscriptProjectName: 'Project',
    okscriptProjectVersion: 'Version',
    okscriptTaskCount: 'Runnable one-time tasks',
    okscriptUnverified:
      '{name} has not been verified yet (only ok-ef is covered for now); run results may be judged inaccurately',
    okscriptNativeConfigHint:
      "Task details come straight from the project's own settings. Change them in the project's native window; this app never touches them",
    okscriptOpenNative: 'Open native window',
    okscriptRunTimeLimitHint:
      'If the project log stops updating for this long without finishing, the run is marked unconfirmed and stopped',
    okscriptSessionTitle: 'Using the {name} native window',
    okscriptSessionDesc:
      'Finish your settings in the project window; the project saves them itself.',
    okscriptSessionDesc2: 'Click "Close native window" when you are done.',
    okscriptSessionClose: 'Close native window',
    okscriptSessionOpened: 'Native window opened',
    okscriptSessionClosed: 'Native window closed',
    okscriptSessionStartFailed: 'Could not open the native window',
    okscriptSessionStopFailed: 'Could not close the native window',
    okscriptSessionSetupFailed: 'Native window error: {p0}',
    okscriptSessionTimeoutWarn:
      'The native window has been open for a while and closes in 30 seconds',
    okscriptTask: 'Task to run',
    okscriptTaskHint:
      'One-time task run on each proxy run; it keeps matching when a project update reorders tasks',
    okscriptTaskPlaceholder: 'Pick the task to run',
    okscriptTaskMissing:
      'The selected task "{name}" no longer exists in this version; pick another',
    okscriptContinuousTask: 'runs continuously, not supported yet',
    okscriptRootPathMissing: 'Pick the ok-script install folder in the script settings first',
    okscriptUserTag: 'User tags',
    okscriptUserTagHint: 'Generated by this app from run results, read-only',
    okscriptLastProxyDate: 'Last proxy date',
    okscriptProxyTimes: 'Proxy count',
    okscriptLastProxyStatus: 'Last proxy result',
    okscriptDataReadOnlyHint: 'Tracked by this app automatically, read-only',
  ...
  scripts: {
    ...
    typeDesc: {
      ...
      OkScript: 'One entry for ok-script projects such as ok-ef; runs their one-time tasks',
    ...
    create: {
      ...
      typeDesc: {
        ...
        OkScript: 'One entry for ok-script projects such as ok-ef',
      },
    },
    toast: {
