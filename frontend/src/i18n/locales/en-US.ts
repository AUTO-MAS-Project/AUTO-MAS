...
export default {
  ...
  edit: {
    ...
    bettergiRightClickRemove: 'Right-click a group to remove it from OneDragon',
    ...
    bettergiInputGroupNames: 'Enter config group name(s), separated by ";" or click a candidate below',
    bettergiInputGroupNamesTip: 'Multiple names like GroupA;GroupB;GroupC are added one by one. Clicking a candidate appends "name;".',
