...
export default {
  ...
  edit: {
    ...
    bettergiOpenLocalRepo: 'Open local repository',
    bettergiBrowseScriptRepo: 'Browse script repository',
    bettergiScriptRepoTitle: 'BetterGI Script Repository',
    bettergiScriptRepoLoading: 'Loading…',
    bettergiScriptRepoEmpty: 'Local script repository has not been cloned yet. Open the script repository in BetterGI first',
    bettergiScriptRepoSearchPlaceholder: 'Search script name / folder name',
    bettergiScriptRepoSubscribe: 'Subscribe',
    bettergiScriptRepoSubscribeNow: 'Download & Deploy Now',
    bettergiScriptRepoAlreadySubscribed: 'Subscribed',
    bettergiScriptRepoSubscribed: 'Recorded. BetterGI will fetch it on next launch',
    bettergiScriptRepoDeployed: 'Deployed to local script folders',
    bettergiScriptRepoSubscribeFailed: 'Subscription failed',
    bettergiScriptRepoSubscribeHint: 'By default only records the subscription; BetterGI fetches it on next launch. To use immediately, click “Download & Deploy Now”',
    bettergiScriptRepoLoadFailed: 'Failed to load script repository',
    bettergiScriptRepoNoMatch: 'No matching script',
    bettergiScriptRepoInvalidId: 'Invalid script ID',
    bettergiRepoDirMissing: 'Local script repository has not been checked out yet. Subscribe to the script repository in BetterGI first',
