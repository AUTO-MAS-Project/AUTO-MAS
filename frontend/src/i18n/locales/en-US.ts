...
export default {
  ...
  edit: {
    ...
    shellConfigImport: 'Import config',
    shellConfigImportHint: 'Bring over the tasks and options configured in MFAAvalonia',
    shellConfigImportTitle: 'Pick the shell config to import',
    shellConfigImportOk: 'Import',
    shellConfigImportCancel: 'Cancel',
    shellConfigImportActive: 'active',
    shellConfigImportEmpty: 'This project has no shell config to import',
    shellConfigImportFailed: 'Importing the shell config failed; check that the project directory is set on the script page',
    shellConfigImportDone: 'Shell config imported',
    shellConfigImportConfirmTitle: 'Import shell config',
    shellConfigImportConfirmContent: 'Importing overwrites the current task queue and options. Continue?',
    ungrouped: 'Ungrouped',
