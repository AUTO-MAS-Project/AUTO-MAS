...
export default {
  ...
  setting: {
    ...
    notify: {
      ...
      openclawWeixinSection: 'WeChat (OpenClaw/iLink) notifications',
      openclawWeixinDoc: 'Open the WeChat iLink protocol docs',
      openclawWeixinEnable: 'Enable WeChat notifications',
      openclawWeixinTip:
        'Push single-account text notifications through the public WeChat OpenClaw/iLink HTTP protocol',
      openclawWeixinSetupHint:
        'The first version does not start OpenClaw or perform QR login. Enter the Bot Token, target user ID, and conversation Context Token from an already logged-in account.',
      openclawWeixinServerAddress: 'iLink server address',
      openclawWeixinServerAddressTip: 'WeChat iLink gateway address; the Tencent public gateway is used by default',
      openclawWeixinServerAddressPlaceholder: 'https://ilinkai.weixin.qq.com',
      openclawWeixinBotToken: 'Bot Token',
      openclawWeixinBotTokenTip: 'The WeChat iLink Bot Token; it is encrypted when stored locally',
      openclawWeixinBotTokenPlaceholder: 'Enter the Bot Token',
      openclawWeixinTargetUserId: 'Target user ID',
      openclawWeixinTargetUserIdTip: 'The WeChat iLink user ID that receives notifications',
      openclawWeixinTargetUserIdPlaceholder: 'Enter the target user ID',
      openclawWeixinContextToken: 'Context Token',
      openclawWeixinContextTokenTip: 'The target conversation context token; it is encrypted locally and must be refreshed when it expires',
      openclawWeixinContextTokenPlaceholder: 'Enter the conversation Context Token',
