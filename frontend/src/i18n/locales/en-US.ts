...
export default {
  ...
  gamesign: {
    ...
    section: {
      ...
      privacyNotice:
        'When obtaining a token by QR code, password, or SMS, MAS does not save the account, phone number, password, or verification code. Passwords and codes exist only for the current request; the SMS phone number stays only in a short in-memory session for up to 10 minutes. None are written to config, logs, or notifications.',
      enable: 'Enable community tools',
      enableDesc:
        'Runs community check-ins on the MAS schedule; manual check-ins ignore the daily automatic limit.',
    ...
    login: {
      kuroTitle: 'Get a Kuro Games token by SMS',
      taygedoTitle: 'Get a Taygedo token with a password',
      sklandTitle: 'Get a Skland token with a password',
      smsDisclaimerTitle: 'SMS sign-in and privacy',
      disclaimerTitle: 'Password sign-in disclaimer',
      currentAccount: 'Account',
      kuroPhone: 'Kuro Games phone number',
      kuroPhonePlaceholder: 'Enter a mainland China phone number',
      smsCode: 'SMS verification code',
      smsCodePlaceholder: 'Enter the SMS verification code',
      sendCode: 'Send code',
      resendCode: 'Resend',
      resendAfter: 'Resend in {seconds}s',
      kuroSessionHint: 'This SMS session expires in {seconds} seconds',
      kuroConflictNotice:
        'The new token may sign the current Kuro Games client session out. Sign in to the client again if needed.',
      smsSubmit: 'Get and save the token',
    ...
    toast: {
      ...
      kuroSmsSendFailed: 'Could not send the Kuro Games SMS code. Check the network and try again.',
      kuroSmsLoginFailed: 'Could not sign in to Kuro Games by SMS. Try again shortly.',
