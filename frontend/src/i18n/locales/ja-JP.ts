...
export default {
  ...
  setting: {
    ...
    notify: {
      ...
      cmccNewMsgSection: '中国移動 New Messaging 通知',
      cmccNewMsgDoc: '中国移動 New Messaging Channel ガイドを開く',
      cmccNewMsgEnable: '中国移動 New Messaging 通知を有効にする',
      cmccNewMsgTip:
        '従来の SMS ではなく、中国移動の 5G New Messaging（RCS）でタスク通知を受け取ります',
      cmccNewMsgApiKey: 'Channel API キー',
      cmccNewMsgApiKeyTip:
        '中国移動 New Messaging Channel の管理者から提供される、ak_ または app_ で始まるキーです',
      cmccNewMsgApiKeyPlaceholder: '中国移動 New Messaging Channel API キーを入力してください',
