...
export default {
  ...
  edit: {
    ...
    shellConfigImport: '設定をインポート',
    shellConfigImportHint: 'MFAAvalonia で設定したタスクとオプションを取り込みます',
    shellConfigImportTitle: 'インポートするシェル設定を選択',
    shellConfigImportOk: 'インポート',
    shellConfigImportCancel: 'キャンセル',
    shellConfigImportActive: '使用中',
    shellConfigImportEmpty: 'このプロジェクトにはインポートできるシェル設定がありません',
    shellConfigImportFailed: 'シェル設定のインポートに失敗しました。スクリプトページでプロジェクトディレクトリを設定してください',
    shellConfigImportDone: 'シェル設定をインポートしました',
    shellConfigImportConfirmTitle: 'シェル設定のインポート',
    shellConfigImportConfirmContent: 'インポートすると現在のタスクキューとオプションが上書きされます。続行しますか？',
    ungrouped: '未分類',
