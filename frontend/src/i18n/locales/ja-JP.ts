...
export default {
  ...
  edit: {
    ...
    bettergiOpenLocalRepo: 'ローカルリポジトリを開く',
    bettergiBrowseScriptRepo: 'スクリプトリポジトリを参照',
    bettergiScriptRepoTitle: 'BetterGI スクリプトリポジトリ',
    bettergiScriptRepoLoading: '読み込み中…',
    bettergiScriptRepoEmpty: 'ローカルスクリプトリポジトリがまだクローンされていません。まずBetterGIでスクリプトリポジトリを開いてください',
    bettergiScriptRepoSearchPlaceholder: 'スクリプト名 / フォルダ名で検索',
    bettergiScriptRepoSubscribe: '購読',
    bettergiScriptRepoSubscribeNow: '今すぐダウンロードして配置',
    bettergiScriptRepoAlreadySubscribed: '購読済み',
    bettergiScriptRepoSubscribed: '購読を記録しました。BetterGI 起動時に自動取得されます',
    bettergiScriptRepoDeployed: 'ローカルスクリプトフォルダに配置しました',
    bettergiScriptRepoSubscribeFailed: '購読に失敗しました',
    bettergiScriptRepoSubscribeHint: 'デフォルトは購読の記録のみ（BetterGI 起動時に自動取得）。今すぐ使う場合は「今すぐダウンロードして配置」をクリック',
    bettergiScriptRepoLoadFailed: 'スクリプトリポジトリの読み込みに失敗しました',
    bettergiScriptRepoNoMatch: '一致するスクリプトがありません',
    bettergiScriptRepoInvalidId: 'スクリプトIDが無効です',
    bettergiRepoDirMissing: 'ローカルスクリプトリポジトリがまだチェックアウトされていません。まずBetterGIでスクリプトリポジトリを購読してください',
