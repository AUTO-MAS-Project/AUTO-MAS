...
export default {
  ...
  plan: {
    ...
    baah: {
      ...
      rowStageHint:
        'その種別で具体的にどのステージをやるか。懸賞手配・特殊任務・学園交流会は「最後のステージ」が選べ、ハードとノーマルは具体的な番号のみ',
      rowTimesHint: 'この種別を何回やるか。「最大」で回数を消化します',
      // -1 を表す選択肢：ステージは「最後のステージ」、回数は「最大」
      stageHighest: '最後のステージ',
      timesMax: '最大',
    },
    toast: {
