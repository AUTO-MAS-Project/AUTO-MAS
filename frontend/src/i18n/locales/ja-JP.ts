...
export default {
  ...
  edit: {
    ...
    bettergiRightClickRemove: 'グループを右クリックすると一条龍から外せます',
    ...
    bettergiInputGroupNames: '設定グループ名を入力（複数は「;」区切り）、または下の候補をクリック',
    bettergiInputGroupNamesTip: '複数名は GroupA;GroupB;GroupC のように順に追加されます。候補クリックで「名前;」が追記されます。',
