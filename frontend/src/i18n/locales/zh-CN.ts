...
export default {
  ...
  edit: {
    ...
    // OkScript 通用专项
    okscriptScriptConfiguration: 'OkScript 脚本配置',
    okscriptScriptNameHint: '用于区分不同的 OkScript 脚本实例',
    okscriptNotOkScript: '脚本类型不是 OkScript',
    okscriptProject: 'ok-script 项目',
    okscriptRootPath: '安装目录',
    okscriptRootPathHint:
      'ok-script 项目（首批支持 ok-ef）的安装根目录，即包含「项目名.exe」和 data 文件夹的那一层',
    okscriptPickRootPath: '请选择 ok-script 项目的安装目录',
    okscriptProbeFailed: '无法识别该目录',
    okscriptProbeSucceeded: '已识别 {name} {version}',
    okscriptProjectName: '项目',
    okscriptProjectVersion: '版本',
    okscriptTaskCount: '可运行的一次性任务',
    okscriptUnverified: '{name} 尚未经过验证（首批只保证 ok-ef），运行结果判定可能不准确',
    ...
    okscriptSessionClose: '关闭原生界面',
    okscriptSessionOpened: '已打开原生界面',
    okscriptSessionClosed: '原生界面已关闭',
    okscriptSessionStartFailed: '打开原生界面失败',
    okscriptSessionStopFailed: '关闭原生界面失败',
    okscriptSessionSetupFailed: '原生界面出错: {p0}',
    okscriptSessionTimeoutWarn: '原生界面已打开较久，30 秒后自动关闭',
    okscriptTask: '运行任务',
    ...
    okscriptLastProxyDate: '上次代理日期',
    okscriptProxyTimes: '代理次数',
    okscriptLastProxyStatus: '上次代理结果',
    okscriptDataReadOnlyHint: '由本软件自动统计，仅供查看',
    // ZZZ-OD 专项
  ...
  scripts: {
    ...
    typeDesc: {
      ...
      OkScript: 'ok-script 项目通用专项，统一接入 ok-ef 等项目并运行其一次性任务',
    ...
    create: {
      ...
      typeDesc: {
        ...
        ZzzOd: '绝区零一条龙 · 自动每日与实例（账号）管理',
        BAAH: '碧蓝档案爱丽丝助手专项，自动完成每日任务与多实例（账号）管理',
        OkScript: '统一接入 ok-ef 等 ok-script 项目',
      },
    },
    toast: {
