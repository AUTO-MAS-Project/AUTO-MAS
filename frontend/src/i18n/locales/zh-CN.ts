...
export default {
  ...
  edit: {
    ...
    shellConfigImport: '导入配置',
    shellConfigImportHint: '把星塔助手（MFAAvalonia）里配好的任务与选项搬过来',
    shellConfigImportTitle: '选择要导入的外壳配置',
    shellConfigImportOk: '导入',
    shellConfigImportCancel: '取消',
    shellConfigImportActive: '当前使用中',
    shellConfigImportEmpty: '这个项目里没有可导入的外壳配置',
    shellConfigImportFailed: '导入外壳配置失败，请确认脚本页已经选好项目目录',
    shellConfigImportDone: '已导入外壳配置',
    shellConfigImportConfirmTitle: '导入外壳配置',
    shellConfigImportConfirmContent: '导入会覆盖当前任务队列与选项，确定继续吗？',
    ungrouped: '未分组',
