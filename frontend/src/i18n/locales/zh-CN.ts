...
export default {
  ...
  comp: {
    ...
    addUser2: '添加用户',
    enabled: '启用',
    activitySkipBadgePeriod: '活动关连错 {n} 天 · 已跳过',
    activitySkipBadgeToday: '活动关今日出错 · 已跳过',
    activitySkipReset: '重置',
    activitySkipResetHint: '重置后立即恢复活动关注入',
    disabled: '禁用',
  ...
  edit: {
    ...
    maaPickMaterial: '选择材料',
    maaNoMaterialOptions: '暂无可选材料，请稍后重试',
    maaStageNotStarted: '未开始',
    activityStateOk: '本期：{stage} · {mat}（{name}）· 正常注入',
    activityStatePreview: '下期：{stage} · {mat}（{name}）· 待开启，开启后自动注入',
    activityStateMatMissing: '{mat} · 本期不掉，将跳过并提示',
    activityStateNoStage: '倒数第{n}关超出本期范围',
    activityStateNoJade: '本期无搓玉关',
    activityStateNoIntent: '未选择活动关',
    activityStateGap: '等待下期活动 · 指派保留',
  ...
  plan: {
    ...
    activity: {
      ...
      candidateOtherSlots: '从其他槽位移入（自动移出原槽位）',
      joinSlot: '加入本槽',
      currentSlot: '当前：{slot}',
      noCandidates: '没有可指派的用户',
      slotJade: '搓玉',
      slotMat: '自定义材料',
      slotLast: '倒{n}',
      planFixed: '固定模式',
      planUnknown: '其他计划表',
      notFollowing: '未跟随本计划表（不出现在指派中）：',
      statusIdle: '空闲',
      statusInject: '{n} 个用户将注入',
      statusAwaiting: '下期 · {n} 人待开启',
      statusSwitchOff: '{name} 总开关未开启',
      statusNoQuickConfig: '{name} 未开启快速配置，不生效',
      statusUserNoMatch: '{name} 本期无匹配关卡',
      statusUserDisabled: '{name} 已停用',
      statusUserSkipped: '{name} 活动关连错 {n} 天 · 已跳过至活动结束',
      statusUserSkippedToday: '{name} 活动关今日出错 · 已跳过当日',
      statusUserGap: '{name} 的服务器本期无活动',
      partialSave: '{n} 个用户写回失败，请稍后重试',
      retry: '重试',
      summary: '{n} 人指派',
      summaryWarn: '{n} 人指派 · {w} 项注意',
      summaryPreview: '{start} 开启 · {n} 人待命',
      metaOngoing: '{start} ~ {expire}',
      metaPreview: '下期数据 MAA 已录入，仅预览不注入',
      metaGap: '等待下期活动 · 指派保留',
      loadFailed: '加载活动关数据失败',
      pickMaterialFirst: '请先在「自定义材料」行选择材料',
  ...
  scripts: {
    ...
    toast: {
      ...
      activitySkipReset: '已重置活动关跳过簿，恢复注入',
      activitySkipResetFailed: '重置活动关跳过簿失败: {error}',
