...
export default {
  ...
  edit: {
    ...
    bettergiOpenLocalRepo: '打开本地仓库',
    bettergiBrowseScriptRepo: '浏览脚本仓库',
    bettergiScriptRepoTitle: 'BetterGI 脚本仓库',
    bettergiScriptRepoLoading: '加载中…',
    bettergiScriptRepoEmpty: '本地脚本仓库尚未克隆，请先在 BetterGI 内打开脚本仓库',
    bettergiScriptRepoSearchPlaceholder: '搜索脚本名 / 目录名',
    bettergiScriptRepoSubscribe: '订阅',
    bettergiScriptRepoSubscribeNow: '立即下载并落地',
    bettergiScriptRepoAlreadySubscribed: '已订阅',
    bettergiScriptRepoSubscribed: '已记录订阅，BetterGI 启动后将自动拉取',
    bettergiScriptRepoDeployed: '已落地到本地脚本目录',
    bettergiScriptRepoSubscribeFailed: '订阅失败',
    bettergiScriptRepoSubscribeHint: '默认仅记录订阅，由 BetterGI 启动后自动拉取；如需立即使用，点「立即下载并落地」',
    bettergiScriptRepoLoadFailed: '脚本仓库加载失败',
    bettergiScriptRepoNoMatch: '无匹配脚本',
    bettergiScriptRepoInvalidId: '脚本 ID 无效',
    bettergiRepoDirMissing: '本地脚本仓库尚未检出，请先在 BetterGI 内订阅脚本仓库',
