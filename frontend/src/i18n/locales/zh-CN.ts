...
export default {
  ...
  edit: {
    ...
    hsrEngineSwitchHint: '两个引擎各有一套设置和副本，切换后原来的值仍保留，切回即恢复。',
    hsrSharedEngineSwitchHint:
      '改的是本脚本的引擎分配，选了「脚本」的用户和没单独指定引擎的「用户」都会跟着换。',
    hsrStageMissingForEngine:
      '{engine} 下还没选副本；副本按引擎分开保存，切回原引擎时之前的选择仍在。',
    ...
    hsrStageType: '副本类型',
    hsrStageTypeTip: '本轮要刷的副本类型；每类副本各自记住上次选的那一项，切回时仍在。',
    hsrStage: '副本',
    ...
    hsrFieldOverriddenTip: '这一项在 MAS 里改过，运行时用这里的值',
    ...
    hsrModeSwitchedScript: '已切到脚本共享任务配置；你自己的那份仍保留，切回「用户」即恢复。',
    hsrModeSwitchedUser: '已切到这个用户自己的任务配置；脚本共享的那份不受影响。',
    hsrModeSwitchedDirect: '本页任务配置已停用，运行时直接使用三月七 / SRA 里的设置。',
