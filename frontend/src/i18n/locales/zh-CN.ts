...
export default {
  ...
  edit: {
    ...
    loadingMaafwProjectInterface: '正在加载项目任务',
    clear: '清空',
    ...
    scriptTypeNotMfw: '脚本类型不是 MFW / M9A / MSS',
    ...
    mfwWaitTimeTip:
      'MAS 启动游戏时的两段等待共用这个上限：先等窗口出现，再等画面稳定——每秒看一眼画面，有内容且连续 5 秒没有变化就提前开始下发任务；脚本初始化与之并行。Unity 游戏窗口出现时往往还在黑屏加载，太早下发任务会被脚本判成识别异常。游戏已在运行时不等画面。',
