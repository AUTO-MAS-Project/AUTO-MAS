            ...
            <a-col :span="12">
              <a-form-item>
                <template #label>
                  <span class="form-label">
                    模拟器 ID
                    <a-tooltip title="安卓端只配置模拟器 ID 与实例 ID">
                      <QuestionCircleOutlined class="help-icon" />
                    </a-tooltip>
                  </span>
                </template>
            ...
            <a-col :span="8">
              <a-form-item>
                <template #label>
                  <span class="form-label">
                    单日代理次数上限
                    <a-tooltip title="达到后跳过该用户，0 表示不限制">
                      <QuestionCircleOutlined class="help-icon" />
                    </a-tooltip>
                  </span>
                </template>
            ...
            <a-col :span="8">
              <a-form-item>
                <template #label>
                  <span class="form-label">
                    运行超时限制
                    <a-tooltip title="日志长时间无变化时判定为超时，单位分钟">
                      <QuestionCircleOutlined class="help-icon" />
                    </a-tooltip>
                  </span>
                </template>
