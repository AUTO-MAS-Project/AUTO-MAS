  ...
  <div class="test-container">
    ...
    <div class="test-section">
      ...
      <div class="button-group">
        <Button type="primary" @click="testBasicDialog">基础对话框</Button>
        <Button type="primary" @click="testCustomDialog">自定义选项</Button>
        <Button type="primary" @click="testLongMessage">长消息测试</Button>
      </div>
...
const showModal = (options: {
  ...
  return new Promise(resolve => {
    ...
    modalOptions.value = options.buttonOptions || ['确定', '取消']
