...
def _load_helpers():
    ...
    return namespace["_configure_mumu_screenshot_enhancement"], namespace[
        "_without_temporary_mumu_extras"
    ]
...
def test_mumu_screenshot_overlay_preserves_native_options_and_is_not_written_back():
    ...
    mumu = runtime["Configurations"]["Default"]["Gui"]["ConnectSettings"]["Extras"][
        "MuMuEmulator12"
    ]
